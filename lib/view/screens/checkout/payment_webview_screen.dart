...
class PaymentScreenState extends State<PaymentWebViewScreen> {
  ...
  Future<bool?> _exitApp() async {
    ...
    if((widget.addFundUrl == null || widget.addFundUrl!.isEmpty) || !Get.find<SplashController>().configModel!.digitalPaymentInfo!.pluginPaymentGateways! || (widget.subscriptionUrl == null || widget.subscriptionUrl!.isEmpty)){

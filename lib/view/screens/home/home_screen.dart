          ...
          child: RefreshIndicator(
            ...
            child: ResponsiveHelper.isDesktop(context) ? WebHomeScreen(
              ...
              slivers: [
                ...
                /// App Bar
                SliverAppBar(
                  pinned: true, toolbarHeight: 10, expandedHeight: ResponsiveHelper.isTab(context) ? 72 : 50,
                            ...
                            Expanded(child: InkWell(
                              ...
                              child: Padding(
                                ...
                                child: GetBuilder<LocationController>(builder: (locationController) {
                                  return locationController.getUserAddress() != null ? Column(mainAxisSize: MainAxisSize.min, children: [

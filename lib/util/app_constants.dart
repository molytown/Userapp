...
class AppConstants {
  static const String appName = 'MOGO Munch';
  static const double appVersion = 7.1;

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const String webHostedUrl = 'https://mogomunch.com';

  static const String baseUrl = 'https://admin.mogomunch.com';
  ...
  static const String loginOtpUri = '/api/v1/auth/otp-login';
  static const String addressUri = '/api/v1/customer/address/get-mogo-code';



  ///Refer & Earn work flow list..
  static final dataList = [
    'invite a friend or business'.tr,
    '${'They Signup to'.tr} ${AppConstants.appName} ${'and put your Referal Code'.tr} ${'They Order their first Food'.tr}',
    'you inmiditely earn your referal money'.tr,
  ];
  ...
  /// Deep Links
  static const String yourScheme = 'MOGO Munch';
  static const String yourHost = 'mogomunch.com';

  /// Languages
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.ukFlag, languageName: 'English', countryCode: 'US', languageCode: 'en'),
